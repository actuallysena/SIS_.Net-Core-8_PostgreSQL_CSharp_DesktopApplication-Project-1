...
using OBS_DataAccessLayer.Models;
...
//        => optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Username=postgres;Password=123456;Database=obs_db;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Bolumler>(entity =>
        {
            ...
            entity.Property(e => e.Baskan).HasColumnName("baskan");
            entity.Property(e => e.BolumAdi)
                .HasMaxLength(255)
                .HasColumnName("bolum_adi");
            entity.Property(e => e.FkFakid).HasColumnName("fk_fakid");
            entity.Property(e => e.FkSekreter).HasColumnName("fk_sekreter");

            entity.HasOne(d => d.BaskanNavigation).WithMany(p => p.Bolumlers)
                .HasForeignKey(d => d.Baskan)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_baskan");

            entity.HasOne(d => d.FkFak).WithMany(p => p.Bolumlers)
                .HasForeignKey(d => d.FkFakid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("bolumler_fk_fakid_fkey");

            entity.HasOne(d => d.FkSekreterNavigation).WithMany(p => p.Bolumlers)
                .HasForeignKey(d => d.FkSekreter)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("bolumler_fk_sekreter_fkey");
        });
        ...
        modelBuilder.Entity<Dersler>(entity =>
        {
            ...
            entity.Property(e => e.FkBolmId).HasColumnName("fk_bolm_id");
            entity.Property(e => e.FkSnf).HasColumnName("fk_snf");
            entity.Property(e => e.Kredi).HasColumnName("kredi");

            entity.HasOne(d => d.FkBolmNavigation).WithMany(p => p.Derslers)
                .HasForeignKey(d => d.FkBolmId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("dersler_fk_bolm_id_fkey");
        ...
        modelBuilder.Entity<Ogrenci>(entity =>
        {
            ...
            entity.HasIndex(e => e.Danisman, "ogrenci_danisman_key").IsUnique();
            ...
            entity.HasOne(d => d.DanismanNavigation).WithOne(p => p.Ogrenci)
                .HasForeignKey<Ogrenci>(d => d.Danisman)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("ogrenci_danisman_fkey");
        ...
        modelBuilder.Entity<Personel>(entity =>
        {
            ...
            entity.Property(e => e.FkFakId).HasColumnName("fk_fak_id");
            ...
            entity.HasOne(d => d.FkFak).WithMany(p => p.Personels)
                .HasForeignKey(d => d.FkFakId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("personel_fk_fak_id_fkey");
        });
        ...
        modelBuilder.Entity<Universite>(entity =>
        {
            ...
            entity.HasOne(d => d.RektorNavigation).WithMany(p => p.Universites)
                .HasForeignKey(d => d.Rektor)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("universite_rektor_fkey");
        });
